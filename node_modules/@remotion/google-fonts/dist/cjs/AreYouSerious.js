...
const getInfo = () => ({
    ...
    fonts: {
        normal: {
            '400': {
                vietnamese: 'https://fonts.gstatic.com/s/areyouserious/v12/ll8kK2GVSSr-PtjQ5nONVcNn430KjTVmOGQ.woff2',
                'latin-ext': 'https://fonts.gstatic.com/s/areyouserious/v12/ll8kK2GVSSr-PtjQ5nONVcNn430KjDVmOGQ.woff2',
                latin: 'https://fonts.gstatic.com/s/areyouserious/v12/ll8kK2GVSSr-PtjQ5nONVcNn430KgjVm.woff2',
            },
        },
    },
});
exports.getInfo = getInfo;
exports.fontFamily = 'Are You Serious';
