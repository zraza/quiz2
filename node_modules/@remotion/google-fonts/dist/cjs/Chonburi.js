...
const getInfo = () => ({
    ...
    fonts: {
        normal: {
            '400': {
                thai: 'https://fonts.gstatic.com/s/chonburi/v12/8AtqGs-wOpGRTBq66LWJHLzriA.woff2',
                vietnamese: 'https://fonts.gstatic.com/s/chonburi/v12/8AtqGs-wOpGRTBq66LWSHLzriA.woff2',
                'latin-ext': 'https://fonts.gstatic.com/s/chonburi/v12/8AtqGs-wOpGRTBq66LWTHLzriA.woff2',
                latin: 'https://fonts.gstatic.com/s/chonburi/v12/8AtqGs-wOpGRTBq66LWdHLw.woff2',
            },
        },
    },
});
exports.getInfo = getInfo;
exports.fontFamily = 'Chonburi';
