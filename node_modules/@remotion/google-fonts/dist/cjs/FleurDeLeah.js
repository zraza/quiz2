...
const getInfo = () => ({
    ...
    fonts: {
        normal: {
            '400': {
                vietnamese: 'https://fonts.gstatic.com/s/fleurdeleah/v9/AYCNpXX7ftYZWLhv9UmPJTMC1v6n4b_G.woff2',
                'latin-ext': 'https://fonts.gstatic.com/s/fleurdeleah/v9/AYCNpXX7ftYZWLhv9UmPJTMC1v-n4b_G.woff2',
                latin: 'https://fonts.gstatic.com/s/fleurdeleah/v9/AYCNpXX7ftYZWLhv9UmPJTMC1vGn4Q.woff2',
            },
        },
    },
});
exports.getInfo = getInfo;
exports.fontFamily = 'Fleur De Leah';
