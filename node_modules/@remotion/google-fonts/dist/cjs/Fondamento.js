...
const getInfo = () => ({
    ...
    fonts: {
        italic: {
            '400': {
                'latin-ext': 'https://fonts.gstatic.com/s/fondamento/v20/4UaFrEJGsxNmFTPDnkaJ96_Z67txEwI.woff2',
                latin: 'https://fonts.gstatic.com/s/fondamento/v20/4UaFrEJGsxNmFTPDnkaJ96_Z5btx.woff2',
            },
        },
        normal: {
            '400': {
                'latin-ext': 'https://fonts.gstatic.com/s/fondamento/v20/4UaHrEJGsxNmFTPDnkaJ96Tp56N1.woff2',
                latin: 'https://fonts.gstatic.com/s/fondamento/v20/4UaHrEJGsxNmFTPDnkaJ96rp5w.woff2',
            },
        },
    },
});
exports.getInfo = getInfo;
exports.fontFamily = 'Fondamento';
