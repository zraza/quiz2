...
const getInfo = () => ({
    ...
    fonts: {
        normal: {
            '400': {
                vietnamese: 'https://fonts.gstatic.com/s/imperialscript/v6/5DCPAKrpzy_H98IV2ISnZBbGrVNfNePkjts.woff2',
                'latin-ext': 'https://fonts.gstatic.com/s/imperialscript/v6/5DCPAKrpzy_H98IV2ISnZBbGrVNfNOPkjts.woff2',
                latin: 'https://fonts.gstatic.com/s/imperialscript/v6/5DCPAKrpzy_H98IV2ISnZBbGrVNfOuPk.woff2',
            },
        },
    },
});
exports.getInfo = getInfo;
exports.fontFamily = 'Imperial Script';
