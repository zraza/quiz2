...
const getInfo = () => ({
    ...
    fonts: {
        normal: {
            '400': {
                'latin-ext': 'https://fonts.gstatic.com/s/kameron/v16/vm82dR7vXErQxuzngLc6LtXI.woff2',
                latin: 'https://fonts.gstatic.com/s/kameron/v16/vm82dR7vXErQxuzngLk6Lg.woff2',
            },
            '500': {
                'latin-ext': 'https://fonts.gstatic.com/s/kameron/v16/vm82dR7vXErQxuzngLc6LtXI.woff2',
                latin: 'https://fonts.gstatic.com/s/kameron/v16/vm82dR7vXErQxuzngLk6Lg.woff2',
