...
const getInfo = () => ({
    ...
    fonts: {
        normal: {
            '400': {
                cyrillic: 'https://fonts.gstatic.com/s/kellyslab/v17/-W_7XJX0Rz3cxUnJC5t6fkALfq0k.woff2',
                'latin-ext': 'https://fonts.gstatic.com/s/kellyslab/v17/-W_7XJX0Rz3cxUnJC5t6fkoLfq0k.woff2',
                latin: 'https://fonts.gstatic.com/s/kellyslab/v17/-W_7XJX0Rz3cxUnJC5t6fkQLfg.woff2',
            },
        },
    },
});
exports.getInfo = getInfo;
exports.fontFamily = 'Kelly Slab';
