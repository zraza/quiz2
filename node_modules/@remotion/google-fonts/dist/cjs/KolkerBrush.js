...
const getInfo = () => ({
    ...
    fonts: {
        normal: {
            '400': {
                vietnamese: 'https://fonts.gstatic.com/s/kolkerbrush/v6/iJWDBXWRZjfKWdvmzwvvog3O5Kh798o.woff2',
                'latin-ext': 'https://fonts.gstatic.com/s/kolkerbrush/v6/iJWDBXWRZjfKWdvmzwvvog3O5ah798o.woff2',
                latin: 'https://fonts.gstatic.com/s/kolkerbrush/v6/iJWDBXWRZjfKWdvmzwvvog3O66h7.woff2',
            },
        },
    },
});
exports.getInfo = getInfo;
exports.fontFamily = 'Kolker Brush';
