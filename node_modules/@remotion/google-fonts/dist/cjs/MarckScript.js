...
const getInfo = () => ({
    ...
    fonts: {
        normal: {
            '400': {
                cyrillic: 'https://fonts.gstatic.com/s/marckscript/v20/nwpTtK2oNgBA3Or78gapdwuyzCg_WMM.woff2',
                'latin-ext': 'https://fonts.gstatic.com/s/marckscript/v20/nwpTtK2oNgBA3Or78gapdwuyxig_WMM.woff2',
                latin: 'https://fonts.gstatic.com/s/marckscript/v20/nwpTtK2oNgBA3Or78gapdwuyyCg_.woff2',
            },
        },
    },
});
exports.getInfo = getInfo;
exports.fontFamily = 'Marck Script';
