...
const getInfo = () => ({
    ...
    fonts: {
        normal: {
            '300': {
                arabic: 'https://fonts.gstatic.com/s/marhey/v6/x3dhck7Laq-T7wlRk48kRNs.woff2',
                'latin-ext': 'https://fonts.gstatic.com/s/marhey/v6/x3dhck7Laq-T7wlRmI8kRNs.woff2',
                latin: 'https://fonts.gstatic.com/s/marhey/v6/x3dhck7Laq-T7wlRlo8k.woff2',
            },
            '400': {
                arabic: 'https://fonts.gstatic.com/s/marhey/v6/x3dhck7Laq-T7wlRk48kRNs.woff2',
                'latin-ext': 'https://fonts.gstatic.com/s/marhey/v6/x3dhck7Laq-T7wlRmI8kRNs.woff2',
