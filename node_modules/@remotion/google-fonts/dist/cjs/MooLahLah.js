...
const getInfo = () => ({
    ...
    fonts: {
        normal: {
            '400': {
                vietnamese: 'https://fonts.gstatic.com/s/moolahlah/v6/dg4h_p_opKZOA0w1AYcm56wlawcegg.woff2',
                'latin-ext': 'https://fonts.gstatic.com/s/moolahlah/v6/dg4h_p_opKZOA0w1AYcm56wkawcegg.woff2',
                latin: 'https://fonts.gstatic.com/s/moolahlah/v6/dg4h_p_opKZOA0w1AYcm56wqawc.woff2',
            },
        },
    },
});
exports.getInfo = getInfo;
exports.fontFamily = 'Moo Lah Lah';
