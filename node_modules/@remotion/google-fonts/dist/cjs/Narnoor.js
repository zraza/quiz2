...
const getInfo = () => ({
    ...
    importName: 'Narnoor',
    version: 'v6',
    url: 'https://fonts.googleapis.com/css2?family=Narnoor:ital,wght@0,400',
    unicodeRanges: {
    ...
    fonts: {
        normal: {
            '400': {
                'gunjala-gondi': 'https://fonts.gstatic.com/s/narnoor/v7/cIf9MaFWuVo-UTyP9FmhYVkH.woff2',
                math: 'https://fonts.gstatic.com/s/narnoor/v7/cIf9MaFWuVo-UTyP9FKhYVkH.woff2',
                symbols: 'https://fonts.gstatic.com/s/narnoor/v7/cIf9MaFWuVo-UTyP9EChYVkH.woff2',
                'latin-ext': 'https://fonts.gstatic.com/s/narnoor/v7/cIf9MaFWuVo-UTyP9CChYVkH.woff2',
                latin: 'https://fonts.gstatic.com/s/narnoor/v7/cIf9MaFWuVo-UTyP9C6hYQ.woff2',
            },
        },
    },
});
exports.getInfo = getInfo;
exports.fontFamily = 'Narnoor';
