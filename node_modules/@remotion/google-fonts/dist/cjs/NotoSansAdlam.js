...
const getInfo = () => ({
    ...
    fonts: {
        normal: {
            '400': {
                adlam: 'https://fonts.gstatic.com/s/notosansadlam/v22/neITzCCpqp0s5pPusPamd81eMfjlzFMbnSo.woff2',
                'latin-ext': 'https://fonts.gstatic.com/s/notosansadlam/v22/neITzCCpqp0s5pPusPamd81eMfjloFMbnSo.woff2',
                latin: 'https://fonts.gstatic.com/s/notosansadlam/v22/neITzCCpqp0s5pPusPamd81eMfjlrlMb.woff2',
            },
            '500': {
                adlam: 'https://fonts.gstatic.com/s/notosansadlam/v22/neITzCCpqp0s5pPusPamd81eMfjlzFMbnSo.woff2',
                'latin-ext': 'https://fonts.gstatic.com/s/notosansadlam/v22/neITzCCpqp0s5pPusPamd81eMfjloFMbnSo.woff2',
...
exports.fontFamily = 'Noto Sans Adlam';
