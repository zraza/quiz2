...
const getInfo = () => ({
    ...
    fonts: {
        normal: {
            '100': {
                kannada: 'https://fonts.gstatic.com/s/notoserifkannada/v27/v6-JGZHLJFKIhClqUYqXDiWqpxQxWSPCTY4CEsI.woff2',
                'latin-ext': 'https://fonts.gstatic.com/s/notoserifkannada/v27/v6-JGZHLJFKIhClqUYqXDiWqpxQxWSPCWY4CEsI.woff2',
                latin: 'https://fonts.gstatic.com/s/notoserifkannada/v27/v6-JGZHLJFKIhClqUYqXDiWqpxQxWSPCV44C.woff2',
            },
            '200': {
                kannada: 'https://fonts.gstatic.com/s/notoserifkannada/v27/v6-JGZHLJFKIhClqUYqXDiWqpxQxWSPCTY4CEsI.woff2',
                'latin-ext': 'https://fonts.gstatic.com/s/notoserifkannada/v27/v6-JGZHLJFKIhClqUYqXDiWqpxQxWSPCWY4CEsI.woff2',
...
exports.fontFamily = 'Noto Serif Kannada';
