...
const getInfo = () => ({
    ...
    fonts: {
        normal: {
            '400': {
                'old-uyghur': 'https://fonts.gstatic.com/s/notoserifolduyghur/v3/v6-KGZbLJFKIhClqUYqXDiGnrVoFRCW6JdwXm8K6GlWM.woff2',
                'latin-ext': 'https://fonts.gstatic.com/s/notoserifolduyghur/v3/v6-KGZbLJFKIhClqUYqXDiGnrVoFRCW6JdwXI-OfJ2w.woff2',
                latin: 'https://fonts.gstatic.com/s/notoserifolduyghur/v3/v6-KGZbLJFKIhClqUYqXDiGnrVoFRCW6JdwXLeOf.woff2',
            },
        },
    },
});
exports.getInfo = getInfo;
exports.fontFamily = 'Noto Serif Old Uyghur';
