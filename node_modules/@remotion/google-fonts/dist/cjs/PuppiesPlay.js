...
const getInfo = () => ({
    ...
    fonts: {
        normal: {
            '400': {
                vietnamese: 'https://fonts.gstatic.com/s/puppiesplay/v9/wlp2gwHZEV99rG6M3NR9uB9fYAhTM_I.woff2',
                'latin-ext': 'https://fonts.gstatic.com/s/puppiesplay/v9/wlp2gwHZEV99rG6M3NR9uB9fYQhTM_I.woff2',
                latin: 'https://fonts.gstatic.com/s/puppiesplay/v9/wlp2gwHZEV99rG6M3NR9uB9fbwhT.woff2',
            },
        },
    },
});
exports.getInfo = getInfo;
exports.fontFamily = 'Puppies Play';
