...
const getInfo = () => ({
    ...
    fonts: {
        normal: {
            '400': {
                cyrillic: 'https://fonts.gstatic.com/s/ruda/v28/k3kfo8YQJOpFqnwdaObJ.woff2',
                vietnamese: 'https://fonts.gstatic.com/s/ruda/v28/k3kfo8YQJOpFqncdaObJ.woff2',
                'latin-ext': 'https://fonts.gstatic.com/s/ruda/v28/k3kfo8YQJOpFqnYdaObJ.woff2',
                latin: 'https://fonts.gstatic.com/s/ruda/v28/k3kfo8YQJOpFqngdaA.woff2',
            },
            '500': {
                cyrillic: 'https://fonts.gstatic.com/s/ruda/v28/k3kfo8YQJOpFqnwdaObJ.woff2',
                vietnamese: 'https://fonts.gstatic.com/s/ruda/v28/k3kfo8YQJOpFqncdaObJ.woff2',
