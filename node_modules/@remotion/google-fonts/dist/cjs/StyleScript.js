...
const getInfo = () => ({
    ...
    fonts: {
        normal: {
            '400': {
                vietnamese: 'https://fonts.gstatic.com/s/stylescript/v11/vm8xdRX3SV7Z0aPa88xzW5nZcF762NY.woff2',
                'latin-ext': 'https://fonts.gstatic.com/s/stylescript/v11/vm8xdRX3SV7Z0aPa88xzW5nZcV762NY.woff2',
                latin: 'https://fonts.gstatic.com/s/stylescript/v11/vm8xdRX3SV7Z0aPa88xzW5nZf176.woff2',
            },
        },
    },
});
exports.getInfo = getInfo;
exports.fontFamily = 'Style Script';
