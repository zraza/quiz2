...
const getInfo = () => ({
    ...
    fonts: {
        italic: {
            '400': {
                'latin-ext': 'https://fonts.gstatic.com/s/zenloop/v9/h0GtssK16UsnJwHsEJ9xkQH_4tOG.woff2',
                latin: 'https://fonts.gstatic.com/s/zenloop/v9/h0GtssK16UsnJwHsEJ9xkQ__4g.woff2',
            },
        },
        normal: {
            '400': {
                'latin-ext': 'https://fonts.gstatic.com/s/zenloop/v9/h0GrssK16UsnJwHsEJ96oQ3n5g.woff2',
                latin: 'https://fonts.gstatic.com/s/zenloop/v9/h0GrssK16UsnJwHsEJ90oQ0.woff2',
            },
        },
    },
});
exports.getInfo = getInfo;
exports.fontFamily = 'Zen Loop';
