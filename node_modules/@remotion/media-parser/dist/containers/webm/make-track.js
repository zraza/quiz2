...
import { getBitDepth, getCodecSegment, getColourSegment, getDisplayHeightSegment, getDisplayWidthSegment, getHeightSegment, getNumberOfChannels, getPrivateData, getSampleRate, getTrackId, getTrackTypeSegment, getWidthSegment, } from './traversal';
export const NO_CODEC_PRIVATE_SHOULD_BE_DERIVED_FROM_SPS = 'no-codec-private-should-be-derived-from-sps';
...
export const getMatroskaAudioCodecWithoutConfigString = ({ track, }) => {
    const codec = getCodecSegment(track);
    if (!codec) {
...
export const getTrack = ({ timescale, track, }) => {
